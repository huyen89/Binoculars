...
class Binoculars(object):
    def __init__(self,
                 observer_name_or_path: str = "Salesforce/codet5-base",
    ...
    def _get_logits(self, encodings: transformers.BatchEncoding) -> torch.Tensor:
        observer_logits = self.observer_model(decoder_inputs_embeds = **encodings.to(DEVICE_1)).logits
        performer_logits = self.performer_model(decoder_inputs_embeds = **encodings.to(DEVICE_2)).logits
        if DEVICE_1 != "cpu":
